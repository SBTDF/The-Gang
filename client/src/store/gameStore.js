...
export const useGameStore = create((set) => ({
  ...
  setPrivateChallengeState: (privateChallengeState) => set({ privateChallengeState }),
  setFalseTrailAdvice: (falseTrailAdvice) => set({ falseTrailAdvice }),
  setCrewVerificationRequest: (crewVerificationRequest) => set({ crewVerificationRequest }),
  setCrewVerificationResult: (crewVerificationResult) => set({ crewVerificationResult }),
